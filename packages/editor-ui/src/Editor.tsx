...
export function Editor({ initialProject, onBackToDashboard }: EditorProps) {
    ...
    <EditorProvider initialProject={initialProject}>
      ...
      <div className="app">
        <header className="app-header">
          <button type="button" className="add-title-button" onClick={onBackToDashboard} title="Back to Dashboard">
            ← Dashboard
          </button>
          <ProjectTitle />
          <SceneStrip />
